...
force ace_common_checkPBOsWhitelist = "['brig_main','brig_rhsfix','cba_settings_userconfig','dorb_debug','dorb_main','dorb_common','dorb_composition','dorb_composition_c1','dorb_composition_c2','dorb_composition_c3','dorb_composition_c4','dorb_composition_c5','dorb_composition_cm1','dorb_composition_cm2','dorb_composition_h1','dorb_composition_h2','dorb_composition_h3','dorb_composition_h4','dorb_composition_h5','dorb_composition_h6','dorb_composition_hm1','dorb_composition_hm2','dorb_composition_hm3','dorb_artillery','dorb_database','dorb_headless','dorb_headquarter','dorb_intercept','dorb_mission','dorb_spawn','dorb_worlds','asr_ai3_cfgammo','asr_ai3_cfgcamouflage','asr_ai3_cfgvehicles','asr_ai3_cfgweapons','asr_ai3_greenrico','asr_ai3_incognito','asr_ai3_main','asr_ai3_rhs_gr_c','asr_ai3_rhs_gr_camo_c','asr_ai3_rhs_ru_c','asr_ai3_rhs_ru_camo_c','asr_ai3_rhs_us_c','asr_ai3_rhs_us_camo_c','asr_ai3_rhs_saf_c','asr_ai3_rhs_saf_camo_c','asr_ai3_bwa3_c','asr_ai3_bwa3_camo_c','asr_ai3_niarms_c','cba_diagnostic_enable_perf_loop','cba_diagnostic_logging','cba_cache_disable','cba_diagnostic_disable_xeh_logging','Disable_XEH_Logging','cba_diagnostic_enable_logging','BWA3_EnablePIPOptics','BWA3_EnablePIPOptics','extdb3','kerb_main','kerb_man','kerb_vehicles']";
...
ace_medical_allowLitterCreation = false;
...
force ace_medical_litterCleanUpDelay = 25;
...
force TFAR_setting_defaultFrequencies_lr_west = "50,40,60,51,41,61,55,45,65";
force TFAR_setting_defaultFrequencies_lr_east = "50,40,60,51,41,61,55,45,65";
force TFAR_setting_defaultFrequencies_lr_independent = "50,40,60,51,41,61,55,45,65";
